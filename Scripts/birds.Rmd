...
dtrait <- dtrait %>% 
  ...
  select(name, synonyms, proj_id, et_id, synonyms, mlife, matage,nest, nsbank, nsgroun, nsgrass, nsclif, nsbuild, nsshru, nssnag, nscact, nstang, nsfloat, ntree, attem, eng_name,nest.tree.use, live_tree_nesting_use, snag_nesting_use, fmhawk, fmfogl, fmbagl, fstimb, fcinvert, nsdeci,nsconi) %>% 
